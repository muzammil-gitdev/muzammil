...
import { ArrowRight, Download, Mail, Github, Linkedin, Terminal, Cpu } from "lucide-react";
            ...
            <div className="container mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2">
                ...
                <div className="flex flex-col items-start text-left z-10 order-2 lg:order-1">
                    ...
                    >
                        ...
                        Passionate about cutting-edge tech and crafting software that solves real-world problems.
                    </motion.p>
                    ...
                    <div className="relative h-[350px] w-[350px] md:h-[450px] md:w-[450px]">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Expertise</p>
                                    <p className="text-sm font-bold text-zinc-900 dark:text-white">Next.js & React</p>
                                </div>
                            </div>
                        </motion.div>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="text-xs font-semibold text-zinc-500 dark:text-zinc-400">Clean Code</p>
                                    <p className="text-sm font-bold text-zinc-900 dark:text-white">Scalable Arch.</p>
                                </div>
                            </div>
                        </motion.div>
