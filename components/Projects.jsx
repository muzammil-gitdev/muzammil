...
const projects = [
    {
        ...
        description: "A comprehensive dashboard for managing online stores, featuring real-time analytics, inventory management, and order tracking. Built with Next.js and Tailwind CSS for optimal performance.",
    ...
    },
    {
        ...
        description: "An interactive travel application helping users discover destinations, plan itineraries, and book accommodations. Features a dynamic map interface and user reviews system.",
    ...
    },
    {
        ...
        description: "A minimalist portfolio template designed specifically for creative professionals to showcase their work. Focuses on imagery and typography with smooth transitions.",
            ...
            <div className="container mx-auto px-6">
                <div className="mb-16 text-center">
                    ...
                    <p className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                        A selection of my recent work, demonstrating clean code and modern design principles.
                    </p>
                </div>
